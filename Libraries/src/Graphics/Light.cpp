...
LightManager::LightManager() { this->ResetAmbientLight(); }
...
LightManager::LightManager(LightManager &&other) noexcept { this->Swap(other); }
...
LightManager::~LightManager() { this->Destroy(); }
...
std::vector<lght::Light> &LightManager::GetLight() { return this->lLight; }

lght::Light &LightManager::GetAmbientLight() { return this->ambientLight; }
