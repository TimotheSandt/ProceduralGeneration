...
void Mesh::InitUniform4f(const char* uniform, const GLfloat* data)
{
    ...
    this->shader.Bind();
    glUniform4fv(GetCachedUniformLocation(sUni), 1, data);
}
...
void Mesh::InitUniform3f(const char* uniform, const GLfloat* data)
{
    ...
    this->shader.Bind();
    glUniform3fv(GetCachedUniformLocation(sUni), 1, data);
}
...
void Mesh::InitUniform2f(const char* uniform, const GLfloat* data)
{
    ...
    this->shader.Bind();
    glUniform2fv(GetCachedUniformLocation(sUni), 1, data);
}
...
void Mesh::InitUniform1f(const char* uniform, const GLfloat* data)
{
    ...
    this->shader.Bind();
    glUniform1fv(GetCachedUniformLocation(sUni), 1, data);
}
...
void Mesh::InitUniform4i(const char* uniform, const GLint* data)
{
    ...
    this->shader.Bind();
    glUniform4iv(GetCachedUniformLocation(sUni), 1, data);
}
...
void Mesh::InitUniform3i(const char* uniform, const GLint* data)
{
    ...
    this->shader.Bind();
    glUniform3iv(GetCachedUniformLocation(sUni), 1, data);
}
...
void Mesh::InitUniform2i(const char* uniform, const GLint* data)
{
    ...
    this->shader.Bind();
    glUniform2iv(GetCachedUniformLocation(sUni), 1, data);
}
...
void Mesh::InitUniform1i(const char* uniform, const GLint* data)
{
    ...
    this->shader.Bind();
    glUniform1iv(GetCachedUniformLocation(sUni), 1, data);
}
...
void Mesh::InitUniformMatrix4f(const char* uniform, const GLfloat* data)
{
    ...
    this->shader.Bind();
    glUniformMatrix4fv(GetCachedUniformLocation(sUni), 1, GL_FALSE, data);
}

GLint Mesh::GetCachedUniformLocation(const std::string& uniform) {
